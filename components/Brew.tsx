...
const Brew = () => {
  ...
  const handleQuantityChange = (e: any ) => {
    let newQuantity = e.nativeEvent.text;
  ...
  return (
    <Card
      ...
      LargeInputComponent={
        <QuantityInput
          defaultValue={
            quantityCtx.brewedCoffeeUnit == "g"
              ? parseFloat(quantityCtx.brewedCoffee.toFixed(1)).toString()
              : parseFloat(
                  (quantityCtx.brewedCoffee / 28.35).toFixed(1)
                ).toString()
          }
          ...
          style={{
            color: isLocked ? colors.locked.largeInput : colors.largeInput,
          }}
        />
      }
      BottomLabelComponent={
        <Unit
          ...
          unit={quantityCtx.brewedCoffeeUnit}
          style={{
            color: isLocked ? colors.locked.unitPrimary : colors.unitPrimary,
          }}
        />
      }
      locked={isLocked}
